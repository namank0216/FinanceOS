...
from lib import data, explainers, smart_money, universe

st.set_page_config(page_title="Smart Money", layout="wide")
...
**Three lenses on what 'people who tend to know' are doing with their money:**

🏛 **Superinvestors** — Warren Buffett (Berkshire), Mohnish Pabrai, Joel Greenblatt, Seth Klarman,
Michael Burry, Bill Ackman, etc. Their fund holdings are public via 13F SEC filings (45-day delay).
**The Grand Portfolio** is the aggregated 'consensus' across all tracked managers — stocks held by
the most legendary investors, ranked by count.

🇺🇸 **Congressional trades** — under the STOCK Act, members of Congress must disclose stock trades
within 45 days. Aggregated to show which tickers are being bought/sold most.

🏢 **Corporate insiders** — CEOs, CFOs, directors filing Form 4. **Cluster buying** (multiple
executives buying simultaneously with their own money) is the strongest insider signal. Selling
is noisier — could be vesting, taxes, diversification.

**How to use these lenses.** When your bottom-up factor analysis (Stage Engine) says BUY on a stock,
and that same stock also shows up on multiple superinvestor portfolios AND has insider buying AND/OR
Congressional buying — that's a high-conviction setup. The signals are independent and confirmatory.
**Don't trade off smart-money signals alone** — they're slow (quarterly) and the people you're
copying have different time horizons and capital structures than you.
""")
